...
typedef struct MI_IPU_TensorShape_s {
    int u32TensorDim;
    MI_IPU_ELEMENT_FORMAT eElmFormat;
    MI_U32 u32TensorShape[MI_IPU_MAX_TENSOR_DIM]; // 3,299,299
} MI_IPU_TensorShape_t;

typedef struct MI_IPU_SubNet_InputOutputDesc_s {
    MI_U32 u32InputTensorCount;
    MI_U32 u32OutputTensorCount;
    MI_IPU_TensorShape_t stMI_InputTensorShapes[MI_IPU_MAX_INPUT_TENSOR_CNT];
    MI_IPU_TensorShape_t stMI_OutputTensorShapes[MI_IPU_MAX_OUTPUT_TENSOR_CNT];
...
typedef struct MI_IPU_TensorVector_s {
    ...
    MI_IPU_Tensor_t  stArrayTensors[MI_IPU_MAX_TENSOR_CNT];
